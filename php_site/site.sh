...
# Start container without proxy on port 80 (If unused)
sudo docker run -d -p 80:80 --name SensorianHub_Site --network=SensorianNet --ip=172.20.0.20 sensorianhub_site:latest
